   ...
   try
     ...
     repeat
       ...
       CloseFile(F);
         ...
         MessageDlg('‘ј…Ћ ќ“—”“—“¬”≈“!',mtError,[mbCancel],0);
         end;
         end;
...
R: Extended;// количество меньше 1 или1
S : Extended;// количество  больше 1
H : Extended; // ответ формулы
begin
...
H:=(1+R)/(1+S);
lbl3.Caption:='формула  = ' + FloatToStr(H);
