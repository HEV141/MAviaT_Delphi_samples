...
if Length(Edit1.Text)=0 then
 begin
 ShowMessage('Введите сумму вклада');
 exit;
 end;
if Length(Edit2.Text)=0 then
 begin
 ShowMessage('Введите процентную ставку');
 exit;
 end;
if Length(Edit3.Text)=0 then
 begin
 ShowMessage('Введите срок вклада');
 exit;
 end;
 begin
...
Label4.Caption:='Доход состовляет: '+FloatToStrF(doh,ffFixed,4,2)+#13+
                'Общая сумма: '+FloatToStrF(sum+doh,ffFixed,4,2);
end;
